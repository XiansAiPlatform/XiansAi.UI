...
replace_env_vars() {
  ...
  echo "  ENTRA_ID_KNOWN_AUTHORITIES: $REACT_APP_ENTRA_ID_KNOWN_AUTHORITIES"
  echo "  ENTRA_ID_AUTHORITY: $REACT_APP_ENTRA_ID_AUTHORITY"
  echo "  ENTRA_ID_SCOPES: $REACT_APP_ENTRA_ID_SCOPES"
  echo "  ENTRA_ID_CLIENT_ID: $REACT_APP_ENTRA_ID_CLIENT_ID"
  echo "  ENTRA_ID_ORGANIZATION_CLAIM: $REACT_APP_ENTRA_ID_ORGANIZATION_CLAIM"
