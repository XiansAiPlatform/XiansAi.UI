...
import GenericOidcSettings from './GenericOidcSettings';
...
const Settings = () => {
  ...
  if (showTenantTab) {
    ...
    tabs.push({ label: "Generic OIDC", component: <GenericOidcSettings /> });
  ...
  const isUsersTab = showTenantTab && currentTab === 4;
