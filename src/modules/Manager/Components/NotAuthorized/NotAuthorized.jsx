  ...
  return (
    <Container maxWidth="md">
      ...
      >
        ...
        >
          {invitation?.token
            ? "You have been invited to join an organization. Please accept the invitation to get started with QIB"
            : "You don't have permission to access this resource. Please contact System Admin for account approval to get started with QIB"
          }
        </Typography>
